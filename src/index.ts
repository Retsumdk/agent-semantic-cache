...
program.name("agent-semantic-cache").description("Semantic caching layer for LLM responses to reduce latency and cost in multi-agent systems").version("1.0.0")
